...
### 2 Run deploy script
   ...
   <div style="text-align:center">
    <span class="dot" onclick="SCATTER(1)"></span>
    <span class="dot" onclick="SCATTER(2)"></span>
    <span class="dot" onclick="SCATTER(3)"></span>
    <span class="dot" onclick="SCATTER(4)"></span>
    <span class="dot" onclick="SCATTER(5)"></span>
</div>
   npm run deploy-frespin%network%
   ```
